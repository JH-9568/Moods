        ...
        child: Column(
          ...
          children: [
            ...
            _buildLabeledField('아이디', TextField(
                ...
                decoration: _inputDecoration('아이디를 입력하세요').copyWith(
                  ...
                  border: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(color: Color.fromRGBO(232, 232, 242, 1)),
                  ),
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(8),
                    borderSide: BorderSide(color: Color.fromRGBO(232, 232, 242, 1), width: 2),
                  ),
                ),
            ...
            _buildLabeledField(
                ...
                obscureText: true,
                decoration: _inputDecoration('8~20자 영문, 숫자의 조합으로 입력해 주세요').copyWith(
                  filled: true,
                  fillColor: Colors.white,
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(8),
